...
$_documentContainer.innerHTML = `<dom-module id="d2l-button-subtle-group-menu">
	<template strip-whitespace="">
		...
		<d2l-dropdown-button-subtle text="[[text]]" class="d2l-dropdown-opener">
...
Polymer({
	is: 'd2l-button-subtle-group-menu',
